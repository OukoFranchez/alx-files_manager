...
/**
 * Generates an image thumbnail with a given width size.
 * @param {String} filePath original file's location.
 * @param {number} size thumbnail's width.
...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/OukoFranchez/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/OukoFranchez">Franchez</a>. ',
